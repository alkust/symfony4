 ...
 */
class Version20180307132602 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE worker ADD job_id INT DEFAULT NULL, DROP job_title, DROP wage');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE worker ADD job_title VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD wage NUMERIC(5, 2) NOT NULL, DROP job_id');
    }
}
